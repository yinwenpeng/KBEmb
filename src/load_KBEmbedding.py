...
def load_TrainDevTest_triples_RankingLoss_EntityRelationNeighbors(trainfile, devfile, testfile, line_no, triple_path):
    #first load entity_vocab
    entity_file=open(triple_path+'entity_vocab_'+str(line_no)+'triples.txt', 'w')
    entity_vocab={}
...
#         print 'r', r
#         print 'train_rtsum.get(r)', train_rtsum.get(r), 'train_rtclasses.get(r)', train_rtclasses.get(r)
#         print 'train_rhsum.get(r)', train_rhsum.get(r), 'train_rhclasses.get(r)', train_rhclasses.get(r)
#         print 'train_r_replace_tail_prop[r]', train_r_replace_tail_prop[r]
#     exit(0)
    ...
    return triples, len(entity_vocab), len(relation_vocab), train_triples_set, train_entity_set, train_relation_set,dev_triples, dev_triples_set, dev_entity_set, dev_relation_set, test_triples, test_triples_set, test_entity_set, test_relation_set, statistic
